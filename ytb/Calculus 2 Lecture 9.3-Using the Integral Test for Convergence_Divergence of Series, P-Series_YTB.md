...
● [0:00]. Fundamental idea of the Integral Test.
     ◉ Main question:
...
● [1:04]. Requirements for applying the Integral Test.
...
● [2:39]. Formal statement of the Integral Test. 
     ◉ Suppose:
          ○ 𝒂ₙ = 𝒇(𝒏)
     ◉ If 𝒇(𝒙) is:
          ○ continuous,
...
● [4:00]. The integral as a bound for the series.
     ◉ Conceptual idea:
...
● [4:45]. ✱ The Integral Test does not necessarily give the sum.
     ◉ If ∫[1,∞] 𝒇(𝒙) ⋅ 𝒅𝑥 = 𝑳
...
● [7:08]. ✱ Adding or subtracting finitely many terms does not affect convergence.
...
● [8:10]. Adjusting the starting point. 
...
● [10:30]. 🧩 Example 1 — Determining convergence for ∑[𝒏=1,∞] 1/(𝒏² + 1).
     ◉ Given series:
          ○ ∑[𝒏=1,∞] 1/(𝒏² + 1)
...
● [12:22]. Applying the Integral Test to Example 1.
     ◉ Define:
          ○ 𝒇(𝒙) = 1/(𝒙² + 1)
...
● [13:40]. Applying the Integral Test to a variant of Example 1: 𝒇(𝒙) = 1/(𝒙² - 1)
     ◉ Check the conditions on [1,∞):
...
● [14:22]. Solving the improper integral in Example 1.
     ◉ Set up the integral:
          ○ ∫[1,∞] 1/(𝒙² + 1) ⋅ 𝒅𝑥
...
● [16:42]. Evaluating the limit in Example 1.
     ◉ Evaluate:
          ○ lim_b→∞ [tan⁻¹(𝒙)]₁ᵇ
          ○ = lim_b→∞ [tan⁻¹(b) - tan⁻¹(1)]
     ◉ Since:
...
● [18:00]. Conclusion for Example 1.
...
● [19:34]. 🧩 Example 2 — Analyzing ∑[𝒏=1,∞] 3/(2𝒏 - 1).
     ◉ Given series:
          ○ ∑[𝒏=1,∞] 3/(2𝒏 - 1)
     ◉ First check the Divergence Test:
          ○ limₙ→∞ 3/(2𝒏 - 1) = 0
...
● [20:12]. Applying the Integral Test to Example 2.
     ◉ Define:
          ○ 𝒇(𝒙) = 3/(2𝒙 - 1)
     ◉ Check the conditions on [1,∞):
          ○ 𝒇(𝒙) is positive.
...
● [21:00]. Solving the improper integral in Example 2.
     ◉ Set up:
          ○ ∫[1,∞] 3/(2𝒙 - 1) ⋅ 𝒅𝑥
     ◉ Rewrite as an improper integral:
          ○ lim_b→∞ ∫[1,b] 3/(2𝒙 - 1) ⋅ 𝒅𝑥
...
● [22:25]. Evaluating the limit in Example 2.
     ◉ Evaluate:
          ○ lim_b→∞ [(3/2) ln(2𝒙 - 1)]₁ᵇ
...
● [25:15]. Conclusion for Example 2.
...
● [26:15]. 🧩 Example 3 — The case of ∑[𝒏=1,∞] ln(𝒏)/𝒏.
     ◉ Given series:
          ○ ∑[𝒏=1,∞] ln(𝒏)/𝒏
     ◉ First check the Divergence Test:
          ○ limₙ→∞ ln(𝒏)/𝒏 = 0
...
● [28:10]. Checking decreasing behavior for Example 3.
     ◉ To prove decreasing,
          ○ take the derivative.
     ◉ Differentiate:
     ...
     ◉ [29:40]. Sign analysis for Example 3.
...
● [31:07]. Adjusting the lower limit in Example 3.
...
● [36:42]. Solving the improper integral in Example 3.
     ◉ Set up:
          ○ ∫[3,∞] ln(𝒙)/𝒙 ⋅ 𝒅𝑥
     ◉ Rewrite as an improper integral:
          ○ lim_b→∞ ∫[3,b] ln(𝒙)/𝒙 ⋅ 𝒅𝑥
...
● [38:41]. Conclusion for Example 3.
     ◉ Evaluate:
          ○ lim_b→∞ [[ln(𝒙)]²/2]₃ᵇ
          ○ = lim_b→∞ ([ln(b)]²/2 - [ln(3)]²/2)
     ◉ Since:
...
● [41:16]. Introduction to 𝒑-Series.
...
● [43:25]. Convergence and divergence rules for 𝒑-Series.
     ◉ 𝒑-series rule:
...
● [49:41]. 🧩 Example — 𝒑-Series: ∑[𝒏=1,∞] 1/𝒏² 
     ◉ Here:
          ○ 𝒑 = 2
     ◉ Since:
          ○ 2 > 1
...
● [50:55]. 🧩 Example — 𝒑-Series: ∑[𝒏=1,∞] 1/∛𝒏 
     ◉ Rewrite:
          ○ ∛𝒏 = 𝒏¹ᐟ³
     ◉ Therefore:
          ○ ∑[𝒏=1,∞] 1/∛𝒏 = ∑[𝒏=1,∞] 1/𝒏¹ᐟ³
...
● [52:11]. 🧩 Example — 𝒑-Series: ∑[𝒏=1,∞] 𝒏^(-𝛑) .png)
     ◉ Rewrite:
          ○ 𝒏^(-𝛑) = 1/𝒏^𝛑
     ◉ Therefore:
          ○ ∑[𝒏=1,∞] 𝒏^(-𝛑) = ∑[𝒏=1,∞] 1/𝒏^𝛑
...
● [56:33]. Important note about recognizing 𝒑-Series.
...
● [57:45]. 🧩 Advanced Example — :∑[𝒏=1,∞] 𝒆¹ᐟⁿ/𝒏². 
     ◉ Given series:
          ○ ∑[𝒏=1,∞] 𝒆¹ᐟⁿ/𝒏²
     ◉ First check the Divergence Test:
          ○ limₙ→∞ 𝒆¹ᐟⁿ/𝒏² = 0
...
● [1:00:25]. Validating the Integral Test conditions for the advanced example.
     ◉ Define:
          ○ 𝒇(𝒙) = 𝒆¹ᐟˣ/𝒙²
     ◉ Check positivity:
          ○ 𝒆¹ᐟˣ is positive.
...
● [1:01:09]. Showing decreasing behavior in the advanced example.
     ◉ Differentiate:
          ○ 𝒇(𝒙) = 𝒆¹ᐟˣ/𝒙²
...
● [1:07:22]. Solving the integral in the advanced example.
     ◉ Set up:
          ○ ∫[1,∞] 𝒆¹ᐟˣ/𝒙² ⋅ 𝒅𝑥
     ◉ Rewrite as an improper integral:
          ○ lim_b→∞ ∫[1,b] 𝒆¹ᐟˣ/𝒙² ⋅ 𝒅𝑥
...
● [1:09:48]. Evaluating the advanced example.
     ◉ Evaluate:
          ○ lim_b→∞ [-𝒆¹ᐟˣ]₁ᵇ
          ○ = lim_b→∞ [-𝒆¹ᐟᵇ - (-𝒆¹)]
     ◉ Since:
...
● [1:10:22]. Final conclusion for the advanced example.
     ◉ Since:
          ○ ∫[1,∞] 𝒆¹ᐟˣ/𝒙² ⋅ 𝒅𝑥 = 𝒆 - 1
     ◉ The improper integral converges.
     ◉ Therefore:
