...
● [0:00]. Introduction to Section 7.4: Partial Fractions.
     ◉ Guiding question:
...
● [1:07]. Two algebra rules that justify the method: “The how”
     ◉ [1:22]. Rule 1 — Polynomial factorization.
     ...
     ◉ [4:15]. Rule 2 — Proper rational functions.
          ○ If every rational function 𝑹(𝒙)/𝑸(𝒙) satisfies
               ■ degree(𝑹) < degree(𝑸),
          ○ then it can be decomposed into partial fractions.

● [5:41]. Clarification of preliminary concepts using the introductory example.
...
● [8:14]. Case 1: **Distinct** linear factors. 
     ◉ Definition.
...
● [11:20]. 🧩 Example 1 — Distinct linear factors: ∫ (4𝒙² − 4𝒙 + 6)/(𝒙³ − 𝒙² − 6𝒙) 𝒅𝒙. 
     ◉ First step:
...
● [37:39]. Shortcut for distinct linear factors. 
...
● [45:10]. 🧩 Example 2 — Long division first: ∫ (𝒙⁴ − 3𝒙² − 3𝒙 − 2)/(𝒙³ − 𝒙² − 2𝒙) 𝒅𝒙. 
...
● [1:05:05]. 🧩 Example 3 —  Transition to case 2, repeated linear factor: ∫ (2𝒙² + 3𝒙 + 7)/(𝒙³ + 𝒙² − 𝒙 − 1) 𝒅𝒙. 
     ◉ First step:
...
● [1:31:31]. 🧩 Example 4 — Transition to case 3: ∫ (𝒙² − 𝒙 − 21)/(2𝒙³ − 𝒙² + 8𝒙 − 4) 𝒅𝒙. 
     ◉ Exam-style approach.
...
● [1:36:54].🧩 Continue Example 4 — Transition to case 3 ∫ (𝒙² − 𝒙 − 21)/(2𝒙³ − 𝒙² + 8𝒙 − 4) 𝒅𝒙.  
     ...
     ◉ [1:55:48]. First method for ∫ 1/(𝒙² + 4) 𝒅𝒙. 
     ...
     ◉ [1:56:48]. Second method for ∫ 1/(𝒙² + 4) 𝒅𝒙.
...
● [2:01:43]. 🧩 Example 4 — Explanation: ∫ 1/(𝒙² + 4) 𝒅𝒙. 
...
● [2:16:10]. Case 4: Repeated irreducible quadratics.
...
● [2:17:02]. Large structural review 🧩 Example — : (5𝒙⁴ − 3𝒙² − 𝒙 + 1) / (𝒙(𝒙 − 1)²(𝒙² + 1)(𝒙² + 𝒙 + 1)²)
...
● [2:23:40]. 🧩 Example 5 — Case 4: Evaluate ∫ (𝒙³ − 2𝒙² + 3𝒙 + 2) / [𝒙(𝒙² + 1)²] 𝒅𝒙. 
     ◉ Correct setup.
...
● [2:55:14]. Closing of the last example.
