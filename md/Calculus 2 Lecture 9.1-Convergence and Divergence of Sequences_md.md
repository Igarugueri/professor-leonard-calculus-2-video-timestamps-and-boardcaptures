...
● [1:37](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=97). Definition of a sequence 𝒂ₙ. [📷image](../img/Calculus 2 Lecture 9.1/[1-37]-01.png)
...
● [4:48](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=288). 🧩 Example 1 — Listing the first terms of the sequence {((-1)ⁿ⁺¹ 2ⁿ)/(n+1)}. [📷image](../img/Calculus 2 Lecture 9.1/[4-48]-01.png)
     ◉ Substitute:
          ○ n = 1  →  𝒂₁ = 1
          ○ n = 2  →  𝒂₂ = -4/3
          ○ n = 3  →  𝒂₃ = 2
...
● [11:15](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=675). 🧩 Example 2 — Evaluating the sequence {(-1)ⁿ √(n - 2)} with starting index n = 2. [📷image](../img/Calculus 2 Lecture 9.1/[11-15]-01.png)
...
● [20:06](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=1206). 🧩 Example 3 — Finding the sequence notation from a list of terms: 2, 3/√2, 4/√3, 5/2, … [📷image](../img/Calculus 2 Lecture 9.1/[20-06]-01.png)
...
● [23:30](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=1410). 🧩 Example 4 — Finding the sequence notation from a list of terms: -1, 1/2, -1/6, 1/24, -1/120, … [📷image](../img/Calculus 2 Lecture 9.1/[23-30]-01.png)
...
● [50:39](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=3039). 🧩 Example 1 — Oscillating sequence: aₙ = (-1)ⁿ.
     ◉ Terms:
          ○ -1, 1, -1, 1, -1, ...
     ◉ Conclusion:
...
● [52:52](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=3172). 🧩 Example 2 — Sequence: aₙ = 2n/(n + 1).
     ◉ Take the limit:
          ○ limₙ→∞ 2n/(n + 1)
...
● [56:51](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=3411). 🧩 Example 3 — Sequence: aₙ = (2 + (-1)ⁿ)/n.
     ◉ Take the limit:
          ○ limₙ→∞ (2 + (-1)ⁿ)/n
     ◉ Rewrite:
          ○ limₙ→∞ [2/n + (-1)ⁿ/n]
...
● [1:01:01](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=3661). 🧩 Example 4 — Sequence: aₙ = ln(n)/n.
     ◉ Take the limit:
          ○ limₙ→∞ ln(n)/n
...
● [1:03:08](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=3788). 🧩 Example 5 — Difference of radicals: aₙ = √(n + 1) - √n
     ◉ Technique:
...
● [1:11:06](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=4266). 🧩 Example — Sequence: aₙ = n!/nⁿ. [📷image](../img/Calculus 2 Lecture 9.1/[1-11-00]-01.png)
     ◉ First observation:
          ○ 0 ≤ aₙ
     ◉ Key comparison:
          ○ n! = n(n - 1)(n - 2) ··· 2·1
...
● [1:29:01](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=5341). 🧩 Example — Sequence: 𝒂ₙ = (-1)ⁿ/𝒏. [📷image](../img/Calculus 2 Lecture 9.1/[1-29-01]-01.png)
     ◉ Absolute value:
          ○ |(-1)ⁿ/𝒏| = 1/𝒏
     ◉ Since
          ○ 1/𝒏 → 0,
...
● [1:36:02](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=5762). 🧩 Example — Sequence: tan⁻¹(𝒏²). [📷image](../img/Calculus 2 Lecture 9.1/[1-36-02]-01.png)
     ◉ Apply the theorem:
          ○ i̲f̲  𝒇 is continuous and limₙ→∞ 𝒂ₙ = 𝑳
               ■ t̲h̲e̲n̲ limₙ→∞ 𝒇(𝒂ₙ) = 𝒇(limₙ→∞ 𝒂ₙ) = 𝒇(𝑳)
     ◉ Identify the parts:
...
● [1:41:10 ]. 🧩 Example — Show that 𝒂ₙ = 𝒏/(𝒏 + 1) is increasing. [📷image](../img/Calculus 2 Lecture 9.1/[1-41-10 ]-01.png)
...
● [1:55:01](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=6901). 🧩 Example — Analyze 𝒇(𝒙) = 𝒙/eˣ. [📷image](../img/Calculus 2 Lecture 9.1/[1-55-01]-01.png)
...
● [2:08:44](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=7724). 🧩 Example — Show that 𝒂ₙ = 2ⁿ/𝒏! is convergent. [📷image-1](../img/Calculus 2 Lecture 9.1/[2-08-44]-01.png) [📷image-2](../img/Calculus 2 Lecture 9.1/[2-08-44]-02.png)
     ...
     ◉ [2:13:05](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=7985). Determine whether 𝒂ₙ = 2ⁿ/𝒏! is decreasing:
          ○ 𝒂ₙ₊₁/𝒂ₙ = (2ⁿ⁺¹/(n + 1)!)/(2ⁿ/n!)
          ○ 𝒂ₙ₊₁/𝒂ₙ = (2ⁿ⁺¹/(n + 1)!) · (n!/2ⁿ)
...
● [2:23:45](https://www.youtube.com/watch?v=FoNLQvf4NUs&t=8625). Summary for geometric sequences 𝒓ⁿ. [📷image](../img/Calculus 2 Lecture 9.1/[2-23-45]-01.png)
     ◉ If -1 < 𝒓 < 1,
          ○ then 𝒓ⁿ → 0
          ○ if 0 < 𝒓 < 1,
