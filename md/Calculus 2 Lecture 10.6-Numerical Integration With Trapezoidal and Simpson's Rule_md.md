...
● [4:18](https://www.youtube.com/watch?v=RTX-ik_8i-k&t=258). 🧩 Example — Approximate: ∫[1,2] (1/𝒙) 𝒅𝒙 with 𝒏 = 10. [📷image](./img/Calculus 2 Lecture 10.6/[4-18]-01.png)
     ◉ Goal:
...
● [16:18](https://www.youtube.com/watch?v=RTX-ik_8i-k&t=978). **Restriction on 𝒏 for Simpson’s Rule.**
     ◉ Condition:
          ○ i̲f̲ 𝒏 is even
...
● [17:19](https://www.youtube.com/watch?v=RTX-ik_8i-k&t=1039). 🧩 Example — Approximate: ∫[0,2] 1/√(𝒙 + 1) 𝒅𝒙 with 𝒏 = 6. [📷image-1](./img/Calculus 2 Lecture 10.6/[17-19]-01.png) [📷image-2](./img/Calculus 2 Lecture 10.6/[17-19]-02.png)
     ◉ Reason:
