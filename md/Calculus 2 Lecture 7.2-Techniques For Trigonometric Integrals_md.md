...
● [1:03](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=63). Case analysis for integrals of the form ∫ sinᵐ(𝒙) cosⁿ(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[1-03]-01.png)
     ◉ Two cases:
...
● [9:47](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=587). 🧩 Example 1 — Both powers odd: ∫ cos³(2𝒙) sin⁵(2𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[9-47]-01.png)
...
● [19:11](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=1151). 🧩 Example 2 —  At least one power is odd: Evaluate ∫ sin³(𝒙) cos²(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[19-11]-01.png)
...
● [27:37](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=1657). 🧩 Example 3 — Both powers are even: ∫ sin⁴(𝒙) cos⁴(𝒙) 𝒅𝒙. [📷image-1](../img/Calculus 2 Lecture 7.2/[27-37]-01.png)  [📷image-2](../img/Calculus 2 Lecture 7.2/[27-37]-02.png)
...
● [48:58](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=2938). 🧩 Example 4 — Without using the reduction formula: Evaluate ∫ sin⁶(𝒙) 𝒅𝒙 [📷image-1](../img/Calculus 2 Lecture 7.2/[48-58]-01.png)  [📷image-2](../img/Calculus 2 Lecture 7.2/[48-58]-02.png) [📷image-3](../img/Calculus 2 Lecture 7.2/[48-58]-03.png)  
     ◉ Rewrite the integrand:
          ○ ∫ sin⁶(𝒙) 𝒅𝒙 = ∫ (sin²(𝒙))³ 𝒅𝒙
     ◉ Use the half-angle identity:
          ○ sin²(𝒙) = (1/2)(1 − cos(2𝒙))
...
● [1:11:06](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=4266). 🧩 Example 5 — Definite integral: ∫[0, π/2] sin³(𝒙) cos¹ᐟ²(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[1-11-06]-01.png)
...
● [1:24:25](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=5065). Integrals involving tangent and secant: ∫ tanᵐ(𝒙) secⁿ(𝒙) 𝒅𝒙   or   ∫ cotᵐ(𝒙) cscⁿ(𝒙) 𝒅𝒙 [📷image-1](../img/Calculus 2 Lecture 7.2/[1-24-25]-01.png)  [📷image-2](../img/Calculus 2 Lecture 7.2/[1-24-25]-02.png)
...
● [1:30:05](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=5405). 🧩 Example 6 — Tangent power odd: ∫ tan⁵(𝒙) sec³(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[1-30-05]-01.png)
...
● [1:36:39](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=5799). 🧩 Example 7 — Evaluate ∫[0, π/4] √tan(𝒙) sec⁶(𝒙) 𝒅𝒙. [📷image-1](../img/Calculus 2 Lecture 7.2/[1-36-39]-01.png)  [📷image-2](../img/Calculus 2 Lecture 7.2/[1-36-39]-02.png)
     ◉ Note:
...
● [1:51:18](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=6678). 🧩 Example 8 — Integrals involving cosecant and cotangent: Evaluate ∫ cot⁵(𝒙) csc⁵(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[1-51-18]-01.png)
...
● [2:03:23](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=7403). 🧩 Example 9 — Simplify ∫ (1 − tan²(𝒙))/sec²(𝒙) 𝒅𝒙. [📷image](../img/Calculus 2 Lecture 7.2/[2-03-23]-01.png)
...
● [2:13:00](https://www.youtube.com/watch?v=pLrUBjiEo-w&t=7980). 🧩 Example 10 — Evaluate ∫[0, π/2] sin(𝒙)cos(2𝒙) 𝒅𝒙.[📷image](../img/Calculus 2 Lecture 7.2/[2-13-00]-01.png)
...
https://www.youtube.com/watch?v=pLrUBjiEo-w&list=PLDesaqWTN6EQ2J4vgsN1HyBeRADEh4Cw-&index=9
