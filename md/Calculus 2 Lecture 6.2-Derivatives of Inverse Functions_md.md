...
● [21:5]. Evaluating inverse functions at specific points without explicit computation.
     ...
     ◉ [22:27](https://www.youtube.com/watch?v=HnsUNWNYZ28&t=1347). 🧩 Example – : 𝒇(𝒙) = 𝒙³ - 1, find 𝒇⁻¹(𝓪) when 𝓪 = -1 [📷image](../img/Calculus 2 Lecture 6.2/[22-27]-01.png)
          ○ 1) Set 𝒇(𝒙) = 𝓪:
               ■ 𝒙³ − 1 = −1
          ○ 2) Solve for 𝒙:
               ■ 𝒙³ = 0
          ...
          ○ 3) Find 𝒇⁻¹(𝓪):
               ■ 𝒇⁻¹(−1) = 0 
     ◉ [27:20](https://www.youtube.com/watch?v=HnsUNWNYZ28&t=1640). 🧩 Example – 𝒇(𝒙) = (3/π)𝒙 + sin(𝒙), find 𝒇⁻¹(𝓪) when 𝓪 = 1 [📷image](../img/Calculus 2 Lecture 6.2/[27-20]-01.png)
          ○ S͟t͟a͟t͟m͟e͟n͟t͟  : 𝒇(𝒙) = 𝓪   ⇔   𝒇⁻¹(𝓪) = 𝒙
          ○ 1) Set 𝒇(𝒙) = 𝓪:
               ■ (3/π)𝒙 + sin(𝒙) = 1
          ○ 2) Solve for 𝒙:
...
● [37:54](https://www.youtube.com/watch?v=HnsUNWNYZ28&t=2274). Application of the derivative of the inverse function evaluated at a given point. 
     ◉ 🧩 Example – Find the derivative of the inverse of: 𝒇(𝒙) = 𝒙³ at the point (2, 8) where 𝒈 = 𝒇⁻¹. [📷image](../img/Calculus 2 Lecture 6.2/[37-54]-01.png)    
          ...
          ○ Apply the derivative formula for inverse functions:
               ...
               ■ 𝒈'(8) = 1 / (3 · 2²)
               ■ 𝒈'(8) = 1 / 12
     ◉ [39:00](https://www.youtube.com/watch?v=HnsUNWNYZ28&t=2340). 🧩 Example – Find the derivative of the inverse of 𝒇(𝒙) = (𝒙² + 1)³ at the point (1, 8), where 𝒈 = 𝒇⁻¹. [📷image](../img/Calculus 2 Lecture 6.2/[39-00]-01.png)    
          ○ Identify the given point on 𝒇:
               ■ 𝒇(1) = (1² + 1)³ = 8
          ○ Identify the corresponding value on the inverse function:
               ■ 𝒈(8) = 1
